...
> **SOLUTION:**: The least heat loss is `635`.
...
Directing the _ultra crucible_ from the lava pool to the machine parts factory, **what is the least heat loss it can incur?**

> **SOLUTION:**: The least heat loss is `734`.
